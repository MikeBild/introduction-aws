...
//npx tsc && AWS_REGION=eu-central-1 catalogBucketName=cms-app-catalog-bucket webSiteBucketName=cms-app-release-websites npx lambda-local -f build/index -e '{"input": {"id":"b1d7a4d0-11a0-11e9-a6ac-37ed6785dc37"}}'
export const handler = async (
  ...
  try {
    const html = await renderFile(
      join(__dirname, 'article-release-website-template.html'),
      data
    );
